...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[waymo_open_dataset.label_pb2.DESCRIPTOR,])
...
_CONTEXT_STATS_OBJECTCOUNT.fields_by_name['type'].enum_type = waymo_open_dataset.label_pb2._LABEL_TYPE
...
_CAMERALABELS.fields_by_name['labels'].message_type = waymo_open_dataset.label_pb2._LABEL
...
_FRAME.fields_by_name['laser_labels'].message_type = waymo_open_dataset.label_pb2._LABEL
...
_FRAME.fields_by_name['no_label_zones'].message_type = waymo_open_dataset.label_pb2._POLYGON2DPROTO
